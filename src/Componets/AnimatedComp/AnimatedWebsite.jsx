...
import {  TextParallaxContentExample } from './Cardcomp';
...
const Website = () => {
  const [isOn, toggleIsOn] = useCycle(false, true)
  return (
    <>
    {/* <Header/> */}
    <section className="bg-[#0a070b] text-white py-16 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
      ...
      className="rounded-lg border-[1px] bg-blue-500 py-2 px-6 text-sm font-medium text-white "
    >
      Book a Demo
    </motion.button>
